...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2023 at 07:34 PM
...
INSERT INTO `process` (`process_id`, `property_id`, `user_id`, `transfer`) VALUES
(3, 1, 1, 'no');
...
(31, '2', 'work', '12 Boulevard', 100, 'house', 'sale', 'ready to move', 'furnished', 1, 11, 9, 1000000, '1', '1', '1', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'CU096uVpX5jB7Lwip9vn.jpg', 'CU096uVpX5jB7Lwip9vn.jpg', 'wRmKHuL3mxhsYQqi9ILe.jpg', 'hey', '2023-01-21 22:27:41', '2023-01-22 07:55:32', 'Pending Payment');
...
(7, 'q', 'q', 'q@q', '$2a$10$njZNeGPMNkX.s6467JGIfuHYdgNWRdi1AEhOfoJ0pmulEG6jEe6wy', 2);
...
--
ALTER TABLE `property`
  MODIFY `property_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

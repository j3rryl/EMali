...
const Listing = ({ image, name, price, type, offer, propertystatus, furnished, address, property_id,valuated, declineProperty,approveProperty }) => {
  ...
  const openProperty=(property_id)=>{
    window.location.assign(`/authuser/valuer/property/${property_id}`)
  }
  return (
    ...
    <div className='card'>
      ...
      <div className='card_info'>
          ...
          <div className='flex align-middle justify-between'>
            <button className='vbutton '  onClick={approveProperty}>Approve</button>
            <button className='vbutton ' onClick={declineProperty} >Decline</button>
          </div>
          <div className='flex align-middle justify-between'>

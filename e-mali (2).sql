...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2023 at 06:22 PM
...
CREATE TABLE `process` (
  ...
  `search` enum('Begin','Terminate','Success') NOT NULL DEFAULT 'Begin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `sales` (`sale_id`, `property_id`, `user_id`, `amount`, `creation_time`) VALUES
(1, 5, 2, 120000, '2023-01-23 15:43:23');
...
--
ALTER TABLE `enquiry`
  MODIFY `enquiry_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `property`
  MODIFY `property_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
